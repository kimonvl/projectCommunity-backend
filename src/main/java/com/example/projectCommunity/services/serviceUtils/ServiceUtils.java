...
public class ServiceUtils {
    public static void checkAccessToProject(ProjectRepo projectRepo, long projectId, String email) {
        Boolean hasAccess = projectRepo.userHasAccessToProject(projectId, email);
        if (hasAccess == null || !hasAccess) {
            throw new UserNotParticipantException("User is not participant in this project");
        }
    }
}
